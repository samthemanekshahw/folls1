...
window.DOMHandler = class {
    ...
    AddRuntimeMessageHandlers(e) {
        for (const [t, n] of e) this.AddRuntimeMessageHandler(t, n)
    }
    GetRuntimeInterface() {
    ...
    constructor(e, t) {
        this._callback = e, this._interval = t, this._timerId = -1, this._lastCallTime = -Infinity, this._timerCallFunc = () => this._OnTimer(), this._ignoreReset = !1, this._canRunImmediate = !1
    }
    ...
    Call() {
        if (-1 === this._timerId) {
            const e = Date.now(),
                ...
                n = this._interval;
            t >= n && this._canRunImmediate ? (this._lastCallTime = e, this._RunCallback()) : this._timerId = self.setTimeout(this._timerCallFunc, Math.max(n - t, 4))
        }
    }
    _RunCallback() {
...
}, "use strict", window.DOMElementHandler = class extends DOMHandler {
    constructor(e, t) {
        super(e, t), this._elementMap = new Map, this._autoAttach = !0, this.AddRuntimeMessageHandler("create", e => this._OnCreate(e)), this.AddRuntimeMessageHandler("destroy", e => this._OnDestroy(e)), this.AddRuntimeMessageHandler("set-visible", e => this._OnSetVisible(e)), this.AddRuntimeMessageHandler("update-position", e => this._OnUpdatePosition(e)), this.AddRuntimeMessageHandler("update-state", e => this._OnUpdateState(e)), this.AddRuntimeMessageHandler("focus", e => this._OnSetFocus(e)), this.AddRuntimeMessageHandler("set-css-style", e => this._OnSetCssStyle(e))
    }
    SetAutoAttach(e) {
        this._autoAttach = !!e
    }
    ...
    _OnCreate(e) {
        ...
        this._elementMap.set(t, n), e.isVisible || (n.style.display = "none"), this._autoAttach && document.body.appendChild(n)
    }
    CreateElement() {
    ...
    _OnDestroy(e) {
        ...
        this.DestroyElement(n), this._autoAttach && n.parentElement.removeChild(n), this._elementMap.delete(t)
    }
    ...
    function t(e) {
        return new Promise((t, n) => {
            ...
            a.onload = t, a.onerror = n, a.async = !1, a.src = e, document.head.appendChild(a)
        })
    }
    async function r(e) {
        const t = await s(e),
    ...
    function s(e) {
        return new Promise((t, n) => {
            ...
            a.onload = e => t(e.target.result), a.onerror = e => n(e), a.readAsArrayBuffer(e)
        })
    }
    ...
    window.RuntimeInterface = class e {
        constructor(e) {
            this._useWorker = e.useWorker, this._messageChannelPort = null, this._baseUrl = "", this._scriptFolder = e.scriptFolder, this._workerScriptBlobURLs = {}, this._worker = null, this._localRuntime = null, this._domHandlers = [], this._runtimeDomHandler = null, this._canvas = null, this._jobScheduler = null, this._rafId = -1, this._rafFunc = () => this._OnRAFCallback(), this._rafCallbacks = [], this._exportType = e.exportType, u(this._exportType) && this._useWorker && (console.warn("[C3 runtime] Worker mode is enabled and supported, but is disabled in WebViews due to crbug.com/923007. Reverting to DOM mode."), this._useWorker = !1), this._transferablesBroken = !1, this._localFileBlobs = null, ("html5" === this._exportType || "playable-ad" === this._exportType) && "file" === location.protocol.substr(0, 4) && alert("Exported games won't work until you upload them. (When running on the file: protocol, browsers block many features from working for security reasons.)"), this.AddRuntimeComponentMessageHandler("runtime", "cordova-fetch-local-file", e => this._OnCordovaFetchLocalFile(e)), this.AddRuntimeComponentMessageHandler("runtime", "create-job-worker", e => this._OnCreateJobWorker(e)), "cordova" === this._exportType ? document.addEventListener("deviceready", () => this._Init(e)) : this._Init(e)
        }
        Release() {
        ...
        async _Init(e) {
            if ("playable-ad" === this._exportType) {
                this._localFileBlobs = self.c3_base64files, await this._ConvertDataUrisToBlobs();
            ...
            if (e.workerScripts)
                for (const [t, n] of Object.entries(e.workerScripts)) this._workerScriptBlobURLs[t] = URL.createObjectURL(n);
            const t = new MessageChannel;
            this._messageChannelPort = t.port1, this._messageChannelPort.onmessage = e => this._OnMessageFromRuntime(e.data), window.c3_addPortMessageHandler && window.c3_addPortMessageHandler(e => this._OnMessageFromDebugger(e)), this._jobScheduler = new self.JobSchedulerDOM(this), await this._jobScheduler.Init(), this.MaybeForceBodySize(), "object" == typeof window.StatusBar && window.StatusBar.hide(), "object" == typeof window.AndroidFullScreen && window.AndroidFullScreen.immersiveMode(), await this._TestTransferablesWork(), this._useWorker ? await this._InitWorker(e, t.port2) : await this._InitDOM(e, t.port2)
        }
        _GetWorkerURL(e) {
        ...
        async CreateWorker(t, n, o) {
            if (t.startsWith("blob:")) return new Worker(t, o);
        ...
        MaybeForceBodySize() {
            if (this.IsiOSWebView()) {
                ...
                n.height = t.height = i + "px", n.width = t.width = o + "px"
            }
        }
        ...
        async _InitWorker(e, t) {
            ...
            }), [t, a, ...this._jobScheduler.GetPortTransferables()]), this._domHandlers = i.map(e => new e(this)), this._FindRuntimeDOMHandler(), self.c3_callFunction = (e, t) => this._runtimeDomHandler._InvokeFunctionFromJS(e, t), "preview" === this._exportType && (self.goToLastErrorScript = () => this.PostToRuntimeComponent("runtime", "go-to-last-error-script"))
        }
        async _InitDOM(n, a) {
            this._canvas = document.createElement("canvas"), this._canvas.style.display = "none", document.body.appendChild(this._canvas), window.c3canvas = this._canvas, this._domHandlers = i.map(e => new e(this)), this._FindRuntimeDOMHandler();
            const o = n.engineScripts.map(e => new URL(e, this._baseUrl).toString());
            if (Array.isArray(n.workerDependencyScripts) && o.unshift(...n.workerDependencyScripts), await Promise.all(o.map(e => t(e))), n.projectScripts && 0 < n.projectScripts.length) {
                const e = self.C3_ProjectScriptsStatus;
                try {
                    if (await Promise.all(n.projectScripts.map(e => t(e[1]))), Object.values(e).some(e => !e)) return void self.setTimeout(() => this._ReportProjectScriptError(e), 100)
                } catch (t) {
                    return console.error("[Preview] Error loading project scripts: ", t), void self.setTimeout(() => this._ReportProjectScriptError(e), 100)
                }
            }
            if ("preview" === this._exportType && "object" != typeof self.C3.ScriptsInEvents) return console.error("[C3 runtime] Failed to load JavaScript code used in events. Check all your JavaScript code has valid syntax."), void alert("Failed to load JavaScript code used in events. Check all your JavaScript code has valid syntax.");
            const d = Object.assign(this._GetCommonRuntimeOptions(n), {
                isInWorker: !1,
                messagePort: a,
                canvas: this._canvas,
                runOnStartupFunctions: m
            });
            this._localRuntime = self.C3_CreateRuntime(d), await self.C3_InitRuntime(this._localRuntime, d)
        }
        _ReportProjectScriptError(e) {
            ...
            console.error("[Preview] " + n), alert(n)
        }
        ...
        PostToRuntimeComponentAsync(t, n, a, o, i) {
            ...
            return this._messageChannelPort.postMessage({
                ...
                data: a,
                responseId: e
            }, this._transferablesBroken ? void 0 : i), d
        }["_OnMessageFromRuntime"](e) {
            const t = e.type;
            if ("event" === t) this._OnEventFromRuntime(e);
            else if ("result" === t) this._OnResultFromRuntime(e);
            else if ("runtime-ready" === t) this._OnRuntimeReady();
            else if ("alert" === t) alert(e.message);
        ...
        _OnEventFromRuntime(t) {
            ...
            const d = e.get(o);
            if (!d) return void console.warn(`[DOM] No handler '${o}' for component '${n}'`);
            let r = null;
            try {
                r = d(a)
            } catch (e) {
                return console.error(`Exception in '${n}' handler '${o}':`, e), void(null !== i && this._PostResultToRuntime(i, !1, e.toString()))
            }
            null !== i && (r && r.then ? r.then(e => this._PostResultToRuntime(i, !0, e)).catch(e => {
                console.error(`Rejection from '${n}' handler '${o}':`, e), this._PostResultToRuntime(i, !1, e.toString())
            }) : this._PostResultToRuntime(i, !0, r))
        }
        _PostResultToRuntime(e, t, n) {
            let a;
            n && n.transferables && (a = n.transferables), this._messageChannelPort.postMessage({
                type: "result",
                responseId: e,
                isOk: t,
                result: n
        ...
        _OnResultFromRuntime(t) {
            const n = t.responseId,
                ...
                o = t.result,
                i = g.get(n);
            a ? i.resolve(o) : i.reject(o), g.delete(n)
        }
        AddRuntimeComponentMessageHandler(e, t, n) {
            let a = y.get(e);
            if (a || (a = new Map, y.set(e, a)), a.has(t)) throw new Error(`[DOM] Component '${e}' already has handler '${t}'`);
            a.set(t, n)
        }
        ...
        CordovaFetchLocalFileAsArrayBuffer(e) {
            return new Promise((t, n) => {
                _.push({
                    filename: e,
                    successCallback: e => {
                        p--, this._CordovaMaybeStartNextArrayBufferRead(), t(e)
                    },
                    errorCallback: e => {
                        p--, this._CordovaMaybeStartNextArrayBufferRead(), n(e)
                    }
        ...
        async _ConvertDataUrisToBlobs() {
            const e = [];
            for (const [t, n] of Object.entries(this._localFileBlobs)) e.push(this._ConvertDataUriToBlobs(t, n));
            await Promise.all(e)
        }
        ...
        _TestTransferablesWork() {
            ...
            return o.port2.onmessage = t => {
                t.data && t.data.arrayBuffer || (this._transferablesBroken = !0, console.warn("MessageChannel transfers determined to be broken. Disabling transferables.")), e()
            }, o.port1.postMessage({
                arrayBuffer: n
            }, [n]), t
        }
    ...
    function s(e) {
        return new Promise((t, n) => {
            ...
            a.onload = () => t(a), a.onerror = e => n(e), a.rel = "stylesheet", a.href = e, document.head.appendChild(a)
        })
    }
    ...
    function a(e) {
        return new Promise((t, n) => {
            const a = new Image;
            a.onload = () => t(a), a.onerror = e => n(e), a.src = e
        })
    }
    async function u(e) {
    ...
    function d(e) {
        return new Promise((t, n) => {
            ...
            a.onload = e => t(e.target.result), a.onerror = e => n(e), a.readAsText(e)
        })
    }
    async function _(e, t, n) {
        if (!/firefox/i.test(navigator.userAgent)) return await u(e);
        let o = await d(e);
        ...
        if (l.hasAttribute("width") && l.hasAttribute("height")) {
            ...
            if (!t.includes("%") && !n.includes("%")) return await u(e)
        }
        l.setAttribute("width", t + "px"), l.setAttribute("height", n + "px");
        const i = new XMLSerializer;
        return o = i.serializeToString(s), e = new Blob([o], {
            type: "image/svg+xml"
        }), await u(e)
    }
    ...
    self.C3_GetSvgImageSize = async function(e) {
        const t = await u(e);
        if (0 < t.width && 0 < t.height) return [t.width, t.height];
        else {
    ...
    const v = class extends DOMHandler {
        constructor(t) {
            ...
            }), window.addEventListener("selectstart", f), window.addEventListener("gesturehold", f), window.addEventListener("touchstart", f, {
                passive: !1
            });
            const a = t.GetCanvas();
            "undefined" == typeof PointerEvent ? a.addEventListener("touchstart", f) : (window.addEventListener("pointerdown", f, {
                passive: !1
            }), a.addEventListener("pointerdown", f)), this._mousePointerLastButtons = 0, window.addEventListener("mousedown", e => {
                1 === e.button && e.preventDefault()
            }), window.addEventListener("mousewheel", g, {
                passive: !1
            }), window.addEventListener("wheel", g, {
                passive: !1
            }), window.addEventListener("resize", () => this._OnWindowResize()), t.IsiOSWebView() && window.addEventListener("focusout", () => {
        ...
        _ScheduleSimulatedResize(e, t, n) {
            -1 !== this._simulatedResizeTimerId && clearTimeout(this._simulatedResizeTimerId), this._simulatedResizeTimerId = setTimeout(() => this._OnSimulatedResize(e, t, n), 48)
        }
        _OnSimulatedResize(t, n, a) {
            const o = this._GetWindowInnerWidth(),
                i = this._GetWindowInnerHeight();
            this._simulatedResizeTimerId = -1, o != t || i != n ? this._PostRuntimeEvent("window-resize", {
                innerWidth: o,
                innerHeight: i,
                devicePixelRatio: window.devicePixelRatio
        ...
        _OnMouseEvent(e, n, a) {
            t(n) || ("mousedown" === e && window !== window.top && window.focus(), this._PostToRuntimeMaybeSync(e, {
                button: n.button,
                buttons: n.buttons,
                clientX: n.clientX,
                clientY: n.clientY,
        ...
        _OnMouseEventAsPointer(e, n) {
            if (!t(n)) {
                ...
                "pointerdown" === e && 0 !== t ? e = "pointermove" : "pointerup" == e && 0 !== n.buttons && (e = "pointermove"), this._PostToRuntimeMaybeSync(e, {
                    pointerId: 1,
                    pointerType: "mouse",
                    button: n.button,
                    buttons: n.buttons,
                    ...
                    twist: 0,
                    timeStamp: n.timeStamp
                }, l), this._mousePointerLastButtons = n.buttons, this._OnMouseEvent(n.type, n, m)
            }
        }
        _OnPointerEvent(e, t) {
            "pointerdown" === e && window !== window.top && window.focus(), this._pointerRawUpdateRateLimiter && ("pointerup" === e || "pointercancel" === e) && this._pointerRawUpdateRateLimiter.Reset();
            let n = 0;
            if ("mouse" === t.pointerType && (n = this._mousePointerLastButtons), this._PostToRuntimeMaybeSync(e, {
                    ...
                    twist: t.twist || 0,
                    timeStamp: t.timeStamp
                }, l), "mouse" === t.pointerType) {
                let n = "mousemove";
                "pointerdown" === e ? n = "mousedown" : "pointerup" == e && (n = "pointerup"), this._OnMouseEvent(n, t, m), this._mousePointerLastButtons = t.buttons
            }
        }
        ...
        _AttachDeviceOrientationEvent() {
            this._attachedDeviceOrientationEvent || (this._attachedDeviceOrientationEvent = !0, window.addEventListener("deviceorientation", e => this._OnDeviceOrientation(e)))
        }
        ...
        _OnUpdateCanvasSize(e) {
            const t = this.GetRuntimeInterface(),
                n = t.GetCanvas();
            n.style.width = e.styleWidth + "px", n.style.height = e.styleHeight + "px", n.style.marginLeft = e.marginLeft + "px", n.style.marginTop = e.marginTop + "px", t.MaybeForceBodySize(), this._isFirstSizeUpdate && (n.style.display = "", this._isFirstSizeUpdate = !1)
        }
        _OnInvokeDownload(t) {
            const n = t.url,
                o = t.filename,
                ...
                e = document.body;
            i.textContent = o, i.href = n, i.download = o, e.appendChild(i), i.click(), e.removeChild(i)
        }
        async _OnRasterSvgImage(t) {
            const n = t.blob,
                ...
                e = t.surfaceHeight,
                r = t.imageBitmapOpts,
                s = await self.C3_RasterSvgImageBlob(n, a, o, d, e);
            let u;
            return u = r ? await createImageBitmap(s, r) : await createImageBitmap(s), {
                imageBitmap: u,
                transferables: [u]
            }
        }
        ...
        _OnDebugHighlight(e) {
            const t = e.show;
            if (!t) return void(this._debugHighlightElem && (this._debugHighlightElem.style.display = "none"));
            ...
            n.style.display = "", n.style.left = e.left - 1 + "px", n.style.top = e.top - 1 + "px", n.style.width = e.width + 2 + "px", n.style.height = e.height + 2 + "px", n.textContent = e.name
        }
        _OnRegisterSW() {
    ...
    RuntimeInterface.AddDOMHandlerClass(v)
} {
    const e = document.currentScript.src;
    self.JobSchedulerDOM = class {
        constructor(t) {
            this._runtimeInterface = t, this._baseUrl = e ? e.substr(0, e.lastIndexOf("/") + 1) : t.GetBaseURL(), this._maxNumWorkers = Math.min(navigator.hardwareConcurrency || 2, 16), this._dispatchWorker = null, this._jobWorkers = [], this._inputPort = null, this._outputPort = null
        }
        async Init() {
        ...
        async _CreateJobWorker() {
            ...
            return this._dispatchWorker.postMessage({
                type: "_addJobWorker",
                port: o.port1
            }, [o.port1]), a.postMessage({
                type: "init",
                number: t,
                "dispatch-port": o.port2,
                "output-port": i.port2
            }, [o.port2, i.port2]), this._jobWorkers.push(a), i.port1
        }
        GetPortData() {
            return {
...
if ("use strict", window.C3_IsSupported) {
    ...
    const t = class extends DOMHandler {
        ...
        async _CreateAudioContext(e) {
            ...
            if ("undefined" != typeof AudioContext) this._audioContext = new AudioContext(t);
        ...
        _UnblockAudioContext() {
            if (!this._hasUnblocked) {
                ...
                n.buffer = t, n.connect(e.destination), n.start(0), "running" === e.state && (this._hasUnblocked = !0, window.removeEventListener("pointerup", this._unblockFunc, !0), window.removeEventListener("touchend", this._unblockFunc, !0), window.removeEventListener("click", this._unblockFunc, !0), window.removeEventListener("keydown", this._unblockFunc, !0), this._unblockFunc = null)
            }
        }
        GetAudioContext() {
        ...
        AddEffectForTag(e, t) {
            ...
            n || (n = [], this._effects.set(e, n)), t._SetIndex(n.length), t._SetTag(e), n.push(t), this._ReconnectEffects(e)
        }
        _ReconnectEffects(e) {
            ...
            for (const n of this.audioInstancesByTag(e)) n.Reconnect(t);
        ...
        ReleaseInstancesForBuffer(t) {
            ...
            for (let o = 0, e = this._audioInstances.length; o < e; ++o) {
                ...
                this._audioInstances[n] = a, a.GetBuffer() === t ? a.Release() : ++n
            }
        ...
        ReleaseAllMusicBuffers() {
            ...
            for (let t = 0, n = this._audioBuffers.length; t < n; ++t) {
                ...
                this._audioBuffers[e] = n, n.IsMusic() ? n.Release() : ++e
            }
            this._audioBuffers.length = e
        }* audioInstancesByTag(t) {
            if (t)
                for (const n of this._audioInstances) e(n.GetTag(), t) && (yield n);
        ...
        async _GetAudioBuffer(t, n, a, o, i) {
            for (const e of this._audioBuffers)
                if (e.GetUrl() === n) return await e.Load(), e;
            if (i) return null;
            ...
            return this._audioBuffers.push(e), await e.Load(), e
        }
        async _GetAudioInstance(t, n, a, o, i) {
            for (const e of this._audioInstances)
                if (e.GetUrl() === n && (e.CanBeRecycled() || i)) return e.SetTag(o), e;
            const e = await this._GetAudioBuffer(t, n, a, i),
                d = e.CreateInstance(o);
            return this._audioInstances.push(d), d
        }
        _AddPendingTag(e) {
        ...
        async _Play(t) {
            ...
            this._lastPlayedTag = e, this._AddPendingTag(e);
            try {
                this._lastAudioInstance = await this._GetAudioInstance(n, a, o, e, d), i ? (this._lastAudioInstance.SetPannerEnabled(!0), this._lastAudioInstance.SetPan(i.x, i.y, i.angle, i.innerAngle, i.outerAngle, i.outerGain), i.hasOwnProperty("uid") && this._lastAudioInstance.SetUID(i.uid)) : this._lastAudioInstance.SetPannerEnabled(!1), this._lastAudioInstance.Play(r, s, u, l)
            } catch (e) {
        ...
        _Stop(e) {
            const t = e.tag;
            for (const n of this.audioInstancesByTag(t)) n.Stop()
        }
        _StopAll() {
        ...
        _SetPaused(e) {
            const t = e.tag,
                n = e.paused;
            for (const a of this.audioInstancesByTag(t)) n ? a.Pause() : a.Resume();
            this._MaybeStartTicking()
        }
        _SetVolume(e) {
            const t = e.tag,
                n = e.vol;
            for (const a of this.audioInstancesByTag(t)) a.SetVolume(n)
        }
        async _FadeVolume(t) {
            const n = t.tag,
                a = t.vol,
            ...
            for (const e of this.audioInstancesByTag(n)) e.FadeVolume(a, o, i);
            this._MaybeStartTicking()
        }
        _SetMasterVolume(e) {
            this._masterVolume = e.vol;
            for (const t of this._audioInstances) t._UpdateVolume()
        }
        _SetMuted(e) {
            const t = e.tag,
                n = e.isMuted;
            for (const a of this.audioInstancesByTag(t)) a.SetMuted(n)
        }
        _SetSilent(e) {
        ...
        _SetLooping(e) {
            const t = e.tag,
                n = e.isLooping;
            for (const a of this.audioInstancesByTag(t)) a.SetLooping(n)
        }
        async _SetPlaybackRate(e) {
            const t = e.tag,
                n = e.rate;
            await this.TagReady(t);
            for (const a of this.audioInstancesByTag(t)) a.SetPlaybackRate(n)
        }
        async _Seek(e) {
            const t = e.tag,
                n = e.pos;
            await this.TagReady(t);
            for (const a of this.audioInstancesByTag(t)) a.Seek(n)
        }
        async _Preload(t) {
            const n = t.originalUrl,
                a = t.url,
        ...
        async _Unload(t) {
            ...
            if (i) {
                i.Release();
                const e = this._audioBuffers.indexOf(i); - 1 !== e && this._audioBuffers.splice(e, 1)
            }
        }
        _UnloadAll() {
        ...
        _SetSuspended(e) {
            ...
            for (const n of this._audioInstances) n.SetSuspended(t);
        ...
        _OnTick(e) {
            ...
            for (const t of e.instPans) {
                const e = t.uid;
                for (const n of this._audioInstances) n.GetUID() === e && n.SetPanXYA(t.x, t.y, t.angle)
            }
        }
        async _AddEffect(t) {
            const n = t.type,
                ...
                o = t.params;
            let i;
            if ("filter" === n) i = new C3AudioFilterFX(this, ...o);
            else if ("delay" === n) i = new C3AudioDelayFX(this, ...o);
                ...
                i = new C3AudioConvolveFX(this, e.GetAudioBuffer(), ...o), i._SetBufferInfo(t.bufferOriginalUrl, t.bufferUrl, t.bufferType)
            } else if ("flanger" === n) i = new C3AudioFlangerFX(this, ...o);
            else if ("phaser" === n) i = new C3AudioPhaserFX(this, ...o);
            else if ("gain" === n) i = new C3AudioGainFX(this, ...o);
            else if ("tremolo" === n) i = new C3AudioTremoloFX(this, ...o);
            else if ("ringmod" === n) i = new C3AudioRingModFX(this, ...o);
            else if ("distortion" === n) i = new C3AudioDistortionFX(this, ...o);
            else if ("compressor" === n) i = new C3AudioCompressorFX(this, ...o);
            else if ("analyser" === n) i = new C3AudioAnalyserFX(this, ...o);
            else throw new Error("invalid effect type");
            this.AddEffectForTag(a, i), this._PostUpdatedFxState()
        }
        _SetEffectParam(t) {
            const n = t.tag,
                a = t.index,
                ...
                e = t.ramp,
                d = t.time,
                r = this._effects.get(n);
            !r || 0 > a || a >= r.length || (r[a].SetParam(o, i, e, d), this._PostUpdatedFxState())
        }
        _RemoveEffects(e) {
            const t = e.tag.toLowerCase(),
                n = this._effects.get(t);
            if (n && n.length) {
                for (const e of n) e.Release();
        ...
        _DoPostUpdatedFxState() {
            const e = {};
            for (const [t, n] of this._effects) e[t] = n.map(e => e.GetState());
        ...
        async _OnLoadState(e) {
            ...
            const n = e.listenerPos;
            this._audioContext.listener.setPosition(n[0], n[1], n[2]), this._isSilent = e.isSilent, this._iRuntime.SetSilent(this._isSilent), this._masterVolume = e.masterVolume;
            const a = [];
            for (const t of Object.values(e.effects)) a.push(Promise.all(t.map(e => this._AddEffect(e))));
            await Promise.all(a), await Promise.all(e.playing.map(e => this._LoadAudioInstance(e, t))), this._MaybeStartTicking()
        }
        async _LoadAudioInstance(t, n) {
            ...
            let l = null;
            try {
                l = await this._GetAudioInstance(a, o, d, r, e)
            } catch (e) {
                return void console.error("[Construct 3] Audio: error loading audio state: ", e)
            }
            l.LoadPanState(t.pan), l.Play(s, u, i, 0), t.isPlaying || l.Pause(), l._LoadAdditionalState(t)
        }
...
"use strict", self.C3AudioBuffer = class {
    constructor(t, n, a, o, i) {
        this._audioDomHandler = t, this._originalUrl = n, this._url = a, this._type = o, this._isMusic = i, this._api = "", this._loadState = "not-loaded", this._loadPromise = null
    }
    Release() {
    ...
    static Create(t, n, a, o, i) {
        ...
        return i && e && t._SetHasAnySoftwareDecodedMusic(), !i || t.IsPlayMusicAsSound() || e ? new C3WebAudioBuffer(t, n, a, o, i, e) : new C3Html5AudioBuffer(t, n, a, o, i)
    }
    CreateInstance(e) {
...
}, "use strict", self.C3WebAudioBuffer = class extends C3AudioBuffer {
    constructor(t, n, a, o, i, e) {
        super(t, n, a, o, i), this._api = "webaudio", this._audioData = null, this._audioBuffer = null, this._needsSoftwareDecode = !!e
    }
    Release() {
    ...
    async _Fetch() {
        ...
        if ("cordova" === e.GetExportType() && e.IsRelativeURL(this._url)) this._audioData = await e.CordovaFetchLocalFileAsArrayBuffer(this._url);
        else {
    ...
    self.C3AudioInstance = class {
        constructor(e, t, n) {
            this._audioDomHandler = e, this._buffer = t, this._tag = n, this._gainNode = this.GetAudioContext().createGain(), this._gainNode.connect(this.GetDestinationNode()), this._pannerNode = null, this._isPannerEnabled = !1, this._isStopped = !0, this._isPaused = !1, this._resumeMe = !1, this._isLooping = !1, this._volume = 1, this._isMuted = !1, this._playbackRate = 1;
            const a = this._audioDomHandler.GetTimeScaleMode();
            this._isTimescaled = 1 === a && !this.IsMusic() || 2 === a, this._instUid = -1, this._fadeEndTime = -1, this._stopOnFadeEnd = !1
        }
        Release() {
        ...
        FadeVolume(t, n, o) {
            if (!this.IsMuted()) {
                ...
                const i = this._audioDomHandler.GetAudioCurrentTime(),
                    e = i + n;
                a.setValueAtTime(a.value, i), a.linearRampToValueAtTime(t, e), this._volume = t, this._fadeEndTime = e, this._stopOnFadeEnd = o
            }
        }
        _UpdateVolume() {
        ...
        Tick(e) {
            -1 !== this._fadeEndTime && e >= this._fadeEndTime && (this._fadeEndTime = -1, this._stopOnFadeEnd && this.Stop(), this._audioDomHandler.PostTrigger("fade-ended", this._tag))
        }
        GetOverallVolume() {
        ...
        SetPan(n, a, o, i, e, d) {
            this._isPannerEnabled && (this.SetPanXYA(n, a, o), this._pannerNode.coneInnerAngle = t(i), this._pannerNode.coneOuterAngle = t(e), this._pannerNode.coneOuterGain = d)
        }
        SetPanXYA(e, t, n) {
            this._isPannerEnabled && (this._pannerNode.setPosition(e, t, 0), this._pannerNode.setOrientation(Math.cos(n), Math.sin(n), 0))
        }
        SetUID(e) {
            this._instUid = e
        }
...
"use strict", self.C3Html5AudioInstance = class extends C3AudioInstance {
    constructor(e, t, n) {
        super(e, t, n), this._buffer.GetOutputNode().connect(this._gainNode), this._buffer.onended = () => this._OnEnded()
    }
    Release() {
    ...
    _OnEnded() {
        this._isStopped = !0, this._instUid = -1, this._audioDomHandler.PostTrigger("ended", this._tag)
    }
    HasEnded() {
    ...
    Play(e, t, n) {
        ...
        if (1 !== a.playbackRate && (a.playbackRate = 1), a.loop !== e && (a.loop = e), this.SetVolume(t), a.muted && (a.muted = !1), a.currentTime !== n) try {
            a.currentTime = n
        } catch (e) {
            console.warn(`[Construct 3] Exception seeking audio '${this._buffer.GetUrl()}' to position '${n}': `, e)
        }
        this._audioDomHandler.TryPlayMedia(a), this._isStopped = !1, this._isPaused = !1, this._isLooping = e, this._playbackRate = 1
    }
    Stop() {
...
}, "use strict", self.C3WebAudioInstance = class extends C3AudioInstance {
    constructor(e, t, n) {
        super(e, t, n), this._bufferSource = null, this._onended_handler = e => this._OnEnded(e), this._hasPlaybackEnded = !0, this._activeSource = null, this._startTime = 0, this._resumePosition = 0, this._muteVol = 1
    }
    Release() {
    ...
    _OnEnded(e) {
        this._isPaused || this._resumeMe || e.target !== this._activeSource || (this._hasPlaybackEnded = !0, this._isStopped = !0, this._instUid = -1, this._ReleaseBufferSource(), this._audioDomHandler.PostTrigger("ended", this._tag))
    }
    HasEnded() {
    ...
    class e {
        ...
        SetAudioParam(t, n, a, o) {
            if (t.cancelScheduledValues(0), 0 === o) return void(t.value = n);
            const i = this._audioContext.currentTime;
            o += i, 0 === a ? t.setValueAtTime(n, o) : 1 === a ? (t.setValueAtTime(t.value, i), t.linearRampToValueAtTime(n, o)) : 2 === a ? (t.setValueAtTime(t.value, i), t.exponentialRampToValueAtTime(n, o)) : void 0
        }
        GetState() {
            return {
                type: this._type,
    ...
    self.C3AudioFilterFX = class extends e {
        constructor(t, n, a, o, i, e, d) {
            super(t), this._type = "filter", this._params = [n, a, o, i, e, d], this._inputNode = this.CreateGain(), this._wetNode = this.CreateGain(), this._wetNode.gain.value = d, this._dryNode = this.CreateGain(), this._dryNode.gain.value = 1 - d, this._filterNode = this._audioContext.createBiquadFilter(), this._filterNode.type = n, this._filterNode.frequency.value = a, this._filterNode.detune.value = o, this._filterNode.Q.value = i, this._filterNode.gain.vlaue = e, this._inputNode.connect(this._filterNode), this._inputNode.connect(this._dryNode), this._filterNode.connect(this._wetNode)
        }
        Release() {
        ...
        SetParam(e, t, n, a) {
            0 === e ? (t = Math.max(Math.min(t / 100, 1), 0), this._params[5] = t, this.SetAudioParam(this._wetNode.gain, t, n, a), this.SetAudioParam(this._dryNode.gain, 1 - t, n, a)) : 1 === e ? (this._params[1] = t, this.SetAudioParam(this._filterNode.frequency, t, n, a)) : 2 === e ? (this._params[2] = t, this.SetAudioParam(this._filterNode.detune, t, n, a)) : 3 === e ? (this._params[3] = t, this.SetAudioParam(this._filterNode.Q, t, n, a)) : 4 === e ? (this._params[4] = t, this.SetAudioParam(this._filterNode.gain, t, n, a)) : void 0
        }
    }, self.C3AudioDelayFX = class extends e {
        constructor(e, t, n, a) {
            super(e), this._type = "delay", this._params = [t, n, a], this._inputNode = this.CreateGain(), this._wetNode = this.CreateGain(), this._wetNode.gain.value = a, this._dryNode = this.CreateGain(), this._dryNode.gain.value = 1 - a, this._mainNode = this.CreateGain(), this._delayNode = this._audioContext.createDelay(t), this._delayNode.delayTime.value = t, this._delayGainNode = this.CreateGain(), this._delayGainNode.gain.value = n, this._inputNode.connect(this._mainNode), this._inputNode.connect(this._dryNode), this._mainNode.connect(this._wetNode), this._mainNode.connect(this._delayNode), this._delayNode.connect(this._delayGainNode), this._delayGainNode.connect(this._mainNode)
        }
        Release() {
        ...
        SetParam(t, a, o, i) {
            0 === t ? (a = Math.max(Math.min(a / 100, 1), 0), this._params[2] = a, this.SetAudioParam(this._wetNode.gain, a, o, i), this.SetAudioParam(this._dryNode.gain, 1 - a, o, i)) : 4 === t ? (this._params[1] = n(a), this.SetAudioParam(this._delayGainNode.gain, n(a), o, i)) : 5 === t ? (this._params[0] = a, this.SetAudioParam(this._delayNode.delayTime, a, o, i)) : void 0
        }
    }, self.C3AudioConvolveFX = class extends e {
        constructor(e, t, n, a) {
            super(e), this._type = "convolution", this._params = [n, a], this._bufferOriginalUrl = "", this._bufferUrl = "", this._bufferType = "", this._inputNode = this.CreateGain(), this._wetNode = this.CreateGain(), this._wetNode.gain.value = a, this._dryNode = this.CreateGain(), this._dryNode.gain.value = 1 - a, this._convolveNode = this._audioContext.createConvolver(), this._convolveNode.normalize = n, this._convolveNode.buffer = t, this._inputNode.connect(this._convolveNode), this._inputNode.connect(this._dryNode), this._convolveNode.connect(this._wetNode)
        }
        Release() {
        ...
        SetParam(e, t, n, a) {
            0 === e ? (t = Math.max(Math.min(t / 100, 1), 0), this._params[1] = t, this.SetAudioParam(this._wetNode.gain, t, n, a), this.SetAudioParam(this._dryNode.gain, 1 - t, n, a)) : void 0
        }
        _SetBufferInfo(e, t, n) {
            this._bufferOriginalUrl = e, this._bufferUrl = t, this._bufferType = n
        }
        GetState() {
        ...
        constructor(t, n, a, o, i, e) {
            super(t), this._type = "flanger", this._params = [n, a, o, i, e], this._inputNode = this.CreateGain(), this._dryNode = this.CreateGain(), this._dryNode.gain.value = 1 - e / 2, this._wetNode = this.CreateGain(), this._wetNode.gain.value = e / 2, this._feedbackNode = this.CreateGain(), this._feedbackNode.gain.value = i, this._delayNode = this._audioContext.createDelay(n + a), this._delayNode.delayTime.value = n, this._oscNode = this._audioContext.createOscillator(), this._oscNode.frequency.value = o, this._oscGainNode = this.CreateGain(), this._oscGainNode.gain.value = a, this._inputNode.connect(this._delayNode), this._inputNode.connect(this._dryNode), this._delayNode.connect(this._wetNode), this._delayNode.connect(this._feedbackNode), this._feedbackNode.connect(this._delayNode), this._oscNode.connect(this._oscGainNode), this._oscGainNode.connect(this._delayNode.delayTime), this._oscNode.start(0)
        }
        Release() {
        ...
        SetParam(e, t, n, a) {
            0 === e ? (t = Math.max(Math.min(t / 100, 1), 0), this._params[4] = t, this.SetAudioParam(this._wetNode.gain, t / 2, n, a), this.SetAudioParam(this._dryNode.gain, 1 - t / 2, n, a)) : 6 === e ? (this._params[1] = t / 1e3, this.SetAudioParam(this._oscGainNode.gain, t / 1e3, n, a)) : 7 === e ? (this._params[2] = t, this.SetAudioParam(this._oscNode.frequency, t, n, a)) : 8 === e ? (this._params[3] = t / 100, this.SetAudioParam(this._feedbackNode.gain, t / 100, n, a)) : void 0
        }
    }, self.C3AudioPhaserFX = class extends e {
        constructor(t, n, a, o, i, e, d) {
            super(t), this._type = "phaser", this._params = [n, a, o, i, e, d], this._inputNode = this.CreateGain(), this._dryNode = this.CreateGain(), this._dryNode.gain.value = 1 - d / 2, this._wetNode = this.CreateGain(), this._wetNode.gain.value = d / 2, this._filterNode = this._audioContext.createBiquadFilter(), this._filterNode.type = "allpass", this._filterNode.frequency.value = n, this._filterNode.detune.value = a, this._filterNode.Q.value = o, this._oscNode = this._audioContext.createOscillator(), this._oscNode.frequency.value = e, this._oscGainNode = this.CreateGain(), this._oscGainNode.gain.value = i, this._inputNode.connect(this._filterNode), this._inputNode.connect(this._dryNode), this._filterNode.connect(this._wetNode), this._oscNode.connect(this._oscGainNode), this._oscGainNode.connect(this._filterNode.frequency), this._oscNode.start(0)
        }
        Release() {
        ...
        SetParam(e, t, n, a) {
            0 === e ? (t = Math.max(Math.min(t / 100, 1), 0), this._params[5] = t, this.SetAudioParam(this._wetNode.gain, t / 2, n, a), this.SetAudioParam(this._dryNode.gain, 1 - t / 2, n, a)) : 1 === e ? (this._params[0] = t, this.SetAudioParam(this._filterNode.frequency, t, n, a)) : 2 === e ? (this._params[1] = t, this.SetAudioParam(this._filterNode.detune, t, n, a)) : 3 === e ? (this._params[2] = t, this.SetAudioParam(this._filterNode.Q, t, n, a)) : 6 === e ? (this._params[3] = t, this.SetAudioParam(this._oscGainNode.gain, t, n, a)) : 7 === e ? (this._params[4] = t, this.SetAudioParam(this._oscNode.frequency, t, n, a)) : void 0
        }
        ...
        SetParam(t, a, o, i) {
            4 === t ? (this._params[0] = n(a), this.SetAudioParam(this._node.gain, n(a), o, i)) : void 0
        }
    }, self.C3AudioTremoloFX = class extends e {
        constructor(e, t, n) {
            super(e), this._type = "tremolo", this._params = [t, n], this._node = this.CreateGain(), this._node.gain.value = 1 - n / 2, this._oscNode = this._audioContext.createOscillator(), this._oscNode.frequency.value = t, this._oscGainNode = this.CreateGain(), this._oscGainNode.gain.value = n / 2, this._oscNode.connect(this._oscGainNode), this._oscGainNode.connect(this._node.gain), this._oscNode.start(0)
        }
        Release() {
        ...
        SetParam(e, t, n, a) {
            0 === e ? (t = Math.max(Math.min(t / 100, 1), 0), this._params[1] = t, this.SetAudioParam(this._node.gain.value, 1 - t / 2, n, a), this.SetAudioParam(this._oscGainNode.gain.value, t / 2, n, a)) : 7 === e ? (this._params[0] = t, this.SetAudioParam(this._oscNode.frequency, t, n, a)) : void 0
        }
    }, self.C3AudioRingModFX = class extends e {
        constructor(e, t, n) {
            super(e), this._type = "ringmod", this._params = [t, n], this._inputNode = this.CreateGain(), this._wetNode = this.CreateGain(), this._wetNode.gain.value = n, this._dryNode = this.CreateGain(), this._dryNode.gain.value = 1 - n, this._ringNode = this.CreateGain(), this._ringNode.gain.value = 0, this._oscNode = this._audioContext.createOscillator(), this._oscNode.frequency.value = t, this._oscNode.connect(this._ringNode.gain), this._oscNode.start(0), this._inputNode.connect(this._ringNode), this._inputNode.connect(this._dryNode), this._ringNode.connect(this._wetNode)
        }
        Release() {
        ...
        SetParam(e, t, n, a) {
            0 === e ? (t = Math.max(Math.min(t / 100, 1), 0), this._params[1] = t, this.SetAudioParam(this._wetNode.gain, t, n, a), this.SetAudioParam(this._dryNode.gain, 1 - t, n, a)) : 7 === e ? (this._params[0] = t, this.SetAudioParam(this._oscNode.frequency, t, n, a)) : void 0
        }
    }, self.C3AudioDistortionFX = class extends e {
        constructor(t, n, a, o, i, e) {
            super(t), this._type = "distortion", this._params = [n, a, o, i, e], this._inputNode = this.CreateGain(), this._preGain = this.CreateGain(), this._postGain = this.CreateGain(), this._SetDrive(o, i), this._wetNode = this.CreateGain(), this._wetNode.gain.value = e, this._dryNode = this.CreateGain(), this._dryNode.gain.value = 1 - e, this._waveShaper = this._audioContext.createWaveShaper(), this._curve = new Float32Array(65536), this._GenerateColortouchCurve(n, a), this._waveShaper.curve = this._curve, this._inputNode.connect(this._preGain), this._inputNode.connect(this._dryNode), this._preGain.connect(this._waveShaper), this._waveShaper.connect(this._postGain), this._postGain.connect(this._wetNode)
        }
        Release() {
        ...
        _SetDrive(e, t) {
            .01 > e && (e = .01), this._preGain.gain.value = e, this._postGain.gain.value = Math.pow(1 / e, .6) * t
        }
        _GenerateColortouchCurve(e, t) {
            for (let n, a = 0; 32768 > a; ++a) n = a / 32768, n = this._Shape(n, e, t), this._curve[32768 + a] = n, this._curve[32768 - a - 1] = -n
        }
        _Shape(e, t, n) {
            const a = 1.05 * n * t - t,
                o = 0 > e ? -1 : 1,
        ...
        SetParam(e, t, n, a) {
            0 === e ? (t = Math.max(Math.min(t / 100, 1), 0), this._params[4] = t, this.SetAudioParam(this._wetNode.gain, t, n, a), this.SetAudioParam(this._dryNode.gain, 1 - t, n, a)) : void 0
        }
    }, self.C3AudioCompressorFX = class extends e {
        constructor(t, n, a, o, i, e) {
            super(t), this._type = "compressor", this._params = [n, a, o, i, e], this._node = this._audioContext.createDynamicsCompressor(), this._node.threshold.value = n, this._node.knee.value = a, this._node.ratio.value = o, this._node.attack.value = i, this._node.release.value = e
        }
        Release() {
            this._node.disconnect(), super.Release()
        }
        ...
        constructor(e, t, n) {
            super(e), this._type = "analyser", this._params = [t, n], this._node = this._audioContext.createAnalyser(), this._node.fftSize = t, this._node.smoothingTimeConstant = n, this._freqBins = new Float32Array(this._node.frequencyBinCount), this._signal = new Uint8Array(t), this._peak = 0, this._rms = 0, this._audioDomHandler._AddAnalyser(this)
        }
        Release() {
        ...
        Tick() {
            ...
            this._peak = 0;
            let t = 0;
            for (let n, a = 0; a < e; ++a) n = (this._signal[a] - 128) / 128, 0 > n && (n = -n), this._peak < n && (this._peak = n), t += n * n;
    ...
    const e = class extends DOMHandler {
        ...
        async _OnRequestPermission(e) {
            const t = e.type;
            let n = !0;
            0 === t ? n = await this._RequestOrientationPermission() : 1 === t && (n = await this._RequestMotionPermission()), this.PostToRuntime("permission-result", {
                type: t,
                result: n
            })
        }
    ...
    const t = {}; {
        ...
        let d = null,
            r = null,
            s = null;
        o("CreateBannerAdvert", async (...e) => {
            const [t, a] = n("CreateBannerAdvert", e);
            await i(50), d ? a("Banner already exists") : (d = "ready", a(null, "Created banner"))
        }), o("ShowBannerAdvert", async (...e) => {
            const [t, a] = n("ShowBannerAdvert", e);
            await i(50), "ready" == d ? (d = "shown", a(null, "Showed banner")) : a("Banner cannot be shown")
        }), o("HideBannerAdvert", async (...e) => {
            const [t, a] = n("HideBannerAdvert", e);
            await i(50), "shown" == d ? (d = null, a(null, "Hid banner")) : a("Banner cannot be hidden")
        }), o("CreateInterstitialAdvert", async (...t) => {
            const [o, a] = n("CreateInterstitialAdvert", t);
            await i(50), r ? a("Intersitial already exists") : (r = "ready", a(null, "Created interstitial"))
        }), o("ShowInterstitialAdvert", async (...t) => {
            const [o, a] = n("ShowInterstitialAdvert", t);
            await i(50), "ready" == r ? (r = null, a(null, "Interstitial shown")) : a("Cannot show interstitial")
        }), o("CreateVideoAdvert", async (...t) => {
            const [o, a] = n("CreateVideoAdvert", t);
            await i(50), s ? a("Video already exists") : (s = "ready", a(null, "Created video"))
        }), o("ShowVideoAdvert", async (...t) => {
            const [o, a] = n("ShowVideoAdvert", t);
            await i(50), "ready" == s ? (s = null, a(null, "[\"example type\", 20]")) : a("Cannot show video")
        }), o("Configure", async (...t) => {
            const [o, a] = n("Configure", t);
            await i(50), a(null, "PERSONALIZED_true")
        }), o("RequestConsent", async (...t) => {
            const [o, a] = n("RequestConsent", t);
            await i(50), a(null, "PERSONALIZED_true")
        }), o("SetUserPersonalisation", async (...t) => {
            const [o, a] = n("SetUserPersonalisation", t);
            await i(50), a(null, o[0] + "_true")
        })
    }
    const n = class extends DOMHandler {
        constructor(e) {
            super(e, "advert");
            const t = e => [e, t => this._CallMethod(e, t)];
            this.AddRuntimeMessageHandlers([t("CreateBannerAdvert"), t("ShowBannerAdvert"), t("HideBannerAdvert"), t("CreateInterstitialAdvert"), t("ShowInterstitialAdvert"), t("CreateVideoAdvert"), t("ShowVideoAdvert"), t("Configure"), t("RequestConsent"), t("SetUserPersonalisation"), t("SetMaxAdContentRating"), t("TagForChildDirectedTreatment"), t("TagForUnderAgeOfConsent")])
        }
        _GetPlugin() {
            if (window.cordova) return window.cordova.plugins.ConstructAd
        }
        async _CallMethod(t, n) {
            const o = this._GetPlugin();
            if (!o) throw e || (e = !0, console.warn("The Mobile Advert plugin is not loaded. Please note that it only works in Android or iOS exports")), new Error("advert plugin not loaded");
    ...
    RuntimeInterface.AddDOMHandlerClass(n)
}